        ...
        <div className={`container ${styles.faqContainer}`}>
          ...
          >
            <Panel key="1" header="What is FRAKT?" className={styles.faqItem}>
              FRAKT started by launching the first generative art on Solana and
              is now building infrastructure to push the ecosystem forward.
            </Panel>
            <Panel
              key="2"
            ...
            >
              ...
              every point you staked is a lottery ticket and every winning
              lottery ticket is a mint on private sale. For $FRKT yield there is
              a formula described &nbsp;
            ...
            >
              ...
              frakts for determined period - usually a week prior launch and
              fill the whitelist form. Amount of points staked determines amount
              of lottery tickets you have in upcoming whitelist lottery. Every
              winning ticket gives you guaranteed mint on low price. Wallets
              with 500 and more points receive at least one guaranteed mint.
              After private sale is ended there is public sale with fcfs.
            </Panel>
            <Panel
              key="7"
            ...
            >
              ...
              guaranteed mints. Since mint price is very low and scarcity is
              huge, we bring more or less same system as with regular Sandbox
              project.
            </Panel>
            <Panel
              key="8"
            ...
            >
              ...
              project page on &nbsp;
              <a href="https://sandbox.frakt.art/">sandbox.frakt.art</a> and
              mint <br />
            ...
            <Panel
              ...
              className={styles.faqItem}
            >
              Fill <a href="https://forms.gle/Y6mgehiY5gCkDUdb6">the form</a>{' '}
              and we will contact you right after!
            </Panel>
            <Panel
              key="10"
